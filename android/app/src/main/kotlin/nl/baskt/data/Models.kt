...
/** A wording the user asked for; tidy and translations follow it. */
@Serializable
data class NamePreference(val id: String, val source: String, val preferred: String, val language: String = "", val createdAt: Long = 0)
...
fun Product.unitPriceLabel(): String? =
    if (unitPriceCents != null && unitPriceUnit != null) "${unitPriceCents.euros()}/${unitPriceUnit.shortUnit()}" else null
...
@Serializable
data class SpeechModel(val id: String, val name: String, val description: String, val voices: List<String>, val languages: List<String>, val voiceNames: Map<String, String> = emptyMap())
@Serializable
