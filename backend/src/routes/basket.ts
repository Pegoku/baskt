...
/**
 * Server-side dictation: a recorded clip (multipart `audio`) is transcribed by the STT pool and
 * interpreted in one round trip. 503 tells the app to dictate on-device instead.
 */
basket.post("/dictate", async (c) => {
